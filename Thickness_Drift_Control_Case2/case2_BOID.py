...
def run(idx):
    ...
    eng.cd(
        r"./MPC_BO_Thickness_ver5.0_CASE2_nonlinear_Varying_Thickness_Temp_s", nargout=0
    )
    ...
    while True:
        try:
            return run_drift(None, False, 100, "vanilla_with_index", 0.03)
        except Exception:
            pass
...
if dlp_mpi.IS_MASTER:
    ...
    save_path = "/PATH_TO_SAVE/CASE2_BOID.pkl"
